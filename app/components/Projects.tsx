              ...
              <div className="group relative bg-gray-900/40 border border-gray-800 rounded-xl overflow-hidden hover:border-red-500/30 transition-all duration-300 hover:bg-gray-900/60 h-full flex flex-col hover:-translate-y-1 hover:shadow-lg">
                ...
                <div className="p-8 flex flex-col flex-grow">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    {/* 2. GitHub Link: Added 'relative z-20' so it sits ON TOP of the card link */}
                    <a
                      href={project.githubLink}
                      className="text-gray-400 hover:text-red-400 transition-colors relative z-20"
                      target='_blank'
                ...
                {/* 3. The Card Link (Invisible Overlay): Covers the whole card, but sits underneath the GitHub link */}
                <a
                  href={project.link}
                  target="_blank"
                  rel="noopener noreferrer"
